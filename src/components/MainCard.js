    ...
    return (
        ...
        <Row className="justify-content-center">
            <div className="cardflex p-2">
                <Cardd src={img2}  percentage={"Level 10"}/>
                <Cardd src={img1}  percentage={"Level 10"}/>
                <Cardd src={img7}  percentage={"Level 10"}/>
                <Cardd src={img}  percentage={"Level 10"}/>
                <Cardd src={img8}  percentage={"Level 10"}/>
             </div>
            ...
            <div className="cardflex p-2">
             ...
             <Row className="justify-content-center">
             <div className="cardflex p-2">
                <Cardd src={img11}  percentage={"Level 6"}/>
                <Cardd src={img12}  percentage={"Level 7"}/>
                <Cardd src={img13}  percentage={"Beginner"}/>
                <Cardd src={img14}  percentage={"Beginner"}/>
                <Cardd src={img15}  percentage={"Beginner"}/>
             </div>
             </Row>
